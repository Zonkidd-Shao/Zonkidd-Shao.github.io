...
date: 2026-08-07
description: "本文是 PTA 编程题'7-24 约分最简分式'的题解，涵盖题目描述、输入输出格式及 C 语言实现，展示使用 `scanf('%d/%d')` 解析'分子/分母'格式输入，并通过辗转相除法（欧几里得算法）求最大公约数 gcd，再将分子分母同除以 gcd 得到最简分式的方法。"
categories:
...
tags:
  ...
  - 算法
weight: 124
slug: PTA基础编程题目集-7-24约分最简分式（C语言实现）
---
