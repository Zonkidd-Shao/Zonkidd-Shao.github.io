...
date: 2026-08-07
description: "本文是 PTA 编程题'7-28 猴子选大王'的题解，涵盖题目描述、输入输出格式及 C 语言实现，展示约瑟夫环问题（N 只猴子围成一圈 1~N 编号，每报到 3 淘汰）的数组模拟解法：用数组值为 0 标记已淘汰、`pos = (pos+1)%n` 实现环形遍历，直到仅剩 1 只猴子即为猴王。"
categories:
...
tags:
  ...
  - 算法
weight: 128
slug: PTA基础编程题目集-7-28猴子选大王（C语言实现）
---
