...
date: 2026-08-07
description: "本文是 PTA 编程题'7-27 冒泡法排序'的题解，涵盖题目描述、输入输出格式及 C 语言实现，展示冒泡排序算法进行 K 趟扫描（每趟将一个最大元素'冒泡'到末尾）的过程，并输出执行完第 K 趟扫描后的中间数组结果。"
categories:
...
tags:
  ...
  - 算法
weight: 127
slug: PTA基础编程题目集-7-27冒泡法排序（C语言实现）
---
