...
date: 2026-08-07
description: "本文是 PTA 编程题'7-22 龟兔赛跑'的题解，涵盖题目描述、输入输出格式及 C 语言实现，展示通过逐分钟模拟（乌龟匀速前进、兔子每跑 10 分钟检查一次并可能休息 30 分钟）的过程模拟法，最终比较 T 分钟后两者距离并按格式输出胜者及距离。"
categories:
...
tags:
  ...
  - 算法
weight: 122
slug: PTA基础编程题目集-7-22龟兔赛跑（C语言实现）
---
