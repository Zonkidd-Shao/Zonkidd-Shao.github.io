...
date: 2026-08-07
description: "本文是 PTA 编程题'7-20 打印九九口诀表'的题解，涵盖题目描述、输入输出格式及 C 语言实现，展示使用双层循环输出下三角乘法口诀表，以及使用 `%-4d` 格式控制符实现等号右边数字左对齐占 4 位的格式化输出方法。"
categories:
...
tags:
  ...
  - 算法
weight: 120
slug: PTA基础编程题目集-7-20打印九九口诀表（C语言实现）
---
