...
date: 2026-08-07
description: "本文是 PTA 编程题'7-36 复数四则运算'的题解，涵盖题目描述、输入输出格式及 C 语言实现，展示将两个复数 C1=a1+b1i、C2=a2+b2i 按 +、−、×、÷ 四则运算公式计算结果，并通过 `printComplex` 函数按'保留一位小数、实部虚部接近 0 时省略、全 0 时输出 0.0'的格式化规则输出完整运算表达式。"
categories:
...
tags:
  ...
  - 算法
weight: 136
slug: PTA基础编程题目集-7-36复数四则运算（C语言实现）
---
